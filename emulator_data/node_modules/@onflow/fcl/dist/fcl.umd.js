(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.onflowFcl = {}));
  ...
  function _configLens() {
    _configLens = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee5(regex) {
  ...
  function _getDiscoveryService() {
    _getDiscoveryService = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee6() {
  ...
  var HTTPRequestError = /*#__PURE__*/function (_Error) {
    ...
    function HTTPRequestError(_ref) {
      ...
      var msg = "\n      HTTP Request Error: An error occurred when interacting with the Access API.\n      ".concat(error ? "error=".concat(error) : "", "\n      ").concat(hostname ? "hostname=".concat(hostname) : "", "\n      ").concat(path ? "path=".concat(path) : "", "\n      ").concat(method ? "method=".concat(method) : "", "\n      ").concat(requestBody ? "requestBody=".concat(JSON.stringify(requestBody)) : "", "\n      ").concat(responseBody ? "responseBody=".concat(JSON.stringify(responseBody)) : "", "\n      ").concat(responseStatusText ? "responseStatusText=".concat(responseStatusText) : "", "\n      ").concat(statusCode ? "statusCode=".concat(statusCode) : "", "\n    ");
      _this = _super.call(this, msg);
      _this.name = "HTTP Request Error";
      _this.statusCode = (_responseBody$code = responseBody === null || responseBody === void 0 ? void 0 : responseBody.code) !== null && _responseBody$code !== void 0 ? _responseBody$code : statusCode;
      _this.errorMessage = responseBody === null || responseBody === void 0 ? void 0 : responseBody.message;
      return _this;
    }
  ...
  function _httpRequest() {
    _httpRequest = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4(_ref2) {
      var hostname, path, method, body, headers, _ref2$retryLimit, retryLimit, _ref2$retryIntervalMs, retryIntervalMs, requestLoop, _requestLoop, makeRequest;
                        ...
                        switch (_context.prev = _context.next) {
                          ...
                          case 9:
                            ...
                            throw new HTTPRequestError({
                              error: responseJSON === null || responseJSON === void 0 ? void 0 : responseJSON.message,
                              hostname: hostname,
                              path: path,
                              method: method,
                              requestBody: body,
                        ...
                        case 8:
                          ...
                          return new Promise(function (resolve, reject) {
                            if (retryAttempt < retryLimit) {
                              console.log("Access node unavailable, retrying in ".concat(retryIntervalMs, " ms..."));
                              setTimeout(function () {
          ...
          switch (_context.prev = _context.next) {
            ...
            case 26:
              ...
              if (_acct.role.payer && _acct.signature != null) {
                id = _acct.tempId || "".concat(_acct.addr, "-").concat(_acct.keyId);
                    ...
                    switch (_context.prev = _context.next) {
                      ...
                      case 13:
                        if (ax.addr != null && ax.keyId != null) {
                          ax.tempId = "".concat(ax.addr, "-").concat(ax.keyId);
                        }
                        ...
                        ix.payer = ix.payer.reduce(function (g, tempId) {
                          ...
                          var key = "".concat(addr, "-").concat(keyId);
  ...
  function mockAccountResponse(ix) {
    var numberOfKeys = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 5; // prettier-ignore
  ...
  var idof = function idof(acct) {
    return "".concat(acct.addr, "-").concat(acct.keyId);
  };
  ...
  function normalizeArgs(ax) {
    if (isFunc(ax)) return ax(arg, types);
    return [];
  }
  ...
  function _query() {
    _query = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
      var opts,
          _args = arguments;
      return regenerator.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              return _context.abrupt("return", send([script(opts.cadence), args(normalizeArgs(opts.args || [])), opts.limit && typeof opts.limit === "number" && limit(opts.limit)]).then(decode));
  ...
  function _preQuery() {
    _preQuery = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(opts) {
      return regenerator.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              invariant$1(isRequired(opts.cadence), "query({ cadence }) -- cadence is required");
              invariant$1(isString(opts.cadence), "query({ cadence }) -- cadence must be a string");
              _context2.t0 = invariant$1;
              _context2.next = 5;
              return config.get("accessNode.api");
  ...
  function _execHttpPost() {
    _execHttpPost = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(service, signable, opts, config) {
  ...
  function _execService() {
    _execService = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(_ref) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.t1 = _objectSpread2({}, config);
              _context.t2 = {};
              _context.next = 7;
  ...
  var HANDLERS$3 = (_HANDLERS$3 = {}, _defineProperty(_HANDLERS$3, INIT, function () {
    ...
    ctx.unsubscribe(letter.from);
  }), _defineProperty(_HANDLERS$3, SNAPSHOT, function () {
  ...
  }()), _defineProperty(_HANDLERS$3, SET_CURRENT_USER, function () {
  ...
  }()), _defineProperty(_HANDLERS$3, DEL_CURRENT_USER, function () {
  ...
  function _getAccountProofData() {
    _getAccountProofData = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee7() {
  ...
  var isServiceMethodUnchangable = function isServiceMethodUnchangable(method) {
    return ["EXT/RPC", "HTTP/POST"].includes(method);
  };
  ...
  function _authenticate() {
    _authenticate = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee9() {
          ...
          switch (_context9.prev = _context9.next) {
            ...
            case 4:
              return _context9.abrupt("return", new Promise( /*#__PURE__*/function () {
                var _ref10 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee8(resolve, reject) {
                    ...
                    while (1) {
                      switch (_context8.prev = _context8.next) {
                        ...
                        case 48:
                          ...
                          _context8.next = 51;
                          return execService({
                            service: _objectSpread2(_objectSpread2({}, service || discoveryService), {}, {
  ...
  function _authorization() {
    _authorization = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee12(account) {
      return regenerator.wrap(function _callee12$(_context12) {
        while (1) {
          switch (_context12.prev = _context12.next) {
            case 0:
                      ...
                      while (1) {
                        switch (_context11.prev = _context11.next) {
                          ...
                          case 11:
                            ...
                            return _context11.abrupt("return", _objectSpread2(_objectSpread2({}, account), {}, {
                              tempId: "CURRENT_USER",
                              resolve: null,
  ...
  function subscribe(callback) {
    ...
    var EXIT = "@EXIT";
    var self = spawn( /*#__PURE__*/function () {
      var _ref8 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee6(ctx) {
        var letter;
        return regenerator.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
  ...
  function snapshot() {
    spawnCurrentUser();
    return _send(NAME, SNAPSHOT, null, {
      expectReply: true,
      timeout: 0
    });
  }
  ...
  function _resolveArgument() {
    _resolveArgument = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee14() {
        ...
        while (1) {
          switch (_context14.prev = _context14.next) {
            ...
            case 2:
              ...
              return _context14.abrupt("return", arg(withPrefix(addr), Address));
  ...
  function _signUserMessage() {
    _signUserMessage = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee15(msg) {
  ...
  var HANDLERS$2 = (_HANDLERS$2 = {}, _defineProperty(_HANDLERS$2, INIT, function () {
    ...
    ctx.unsubscribe(letter.from);
  }), _defineProperty(_HANDLERS$2, SNAPSHOT$1, function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(ctx, letter) {
      return regenerator.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
  ...
  }()), _defineProperty(_HANDLERS$2, POLL, function () {
  ...
  function _mutate() {
    _mutate = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
      var opts,
          txid,
          authz,
          _args = arguments;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 6:
              authz = _context.sent;
              // prettier-ignore
              txid = send([transaction$1(opts.cadence), args(normalizeArgs(opts.args || [])), opts.limit && isNumber(opts.limit) && limit(opts.limit), // opts.proposer > opts.authz > authz
  ...
  function _prepMutation() {
    _prepMutation = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(opts) {
      return regenerator.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              // prettier-ignore
              invariant$1(isRequired(opts), "mutate(opts) -- opts is required"); // prettier-ignore

              invariant$1(isObject(opts), "mutate(opts) -- opts must be an object"); // prettier-ignore

              invariant$1(isRequired(opts.cadence), "mutate({ cadence }) -- cadence is required"); // prettier-ignore

              invariant$1(isString(opts.cadence), "mutate({ cadence }) -- cadence must be a string"); // prettier-ignore
  ...
  var HANDLERS$1 = (_HANDLERS$1 = {}, _defineProperty(_HANDLERS$1, TICK, function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(ctx) {
  ...
  }()), _defineProperty(_HANDLERS$1, SUBSCRIBE, function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(ctx, letter) {
      return regenerator.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
  ...
  var HANDLERS = (_HANDLERS = {}, _defineProperty(_HANDLERS, INIT, function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(ctx) {
      return regenerator.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              window.onload = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
                var services;
                return regenerator.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
    ...
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(ctx, letter) {
      return regenerator.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              return _context3.abrupt("return", letter.reply(_objectSpread2({}, ctx.all())));
  ...
  var spawnProviders = function spawnProviders() {
    return spawn(HANDLERS, SERVICE_ACTOR_KEYS.AUTHN);
  };
  ...
  exports.authorization = authorization$1;
